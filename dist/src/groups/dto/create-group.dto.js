...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Human friendly group name used to cluster devices', example: 'Greenhouse West' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateGroupDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Optional description that explains this device group', required: false }),

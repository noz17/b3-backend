...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Broadcast a command payload to a single device channel' }),
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Command published to the device-specific topic' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Publish a command payload to all devices in a group' }),
